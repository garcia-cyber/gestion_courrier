		...
		<div class="nav-header">
            <a href="admin.php" class="brand-logo">
                <svg class="logo-abbr" width="55" height="55" viewbox="0 0 55 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <img src="images/99f70fe7d427e6c6cf994260ff04f24b.jpg" style="width:50px;height: 50px;border-radius: 100%;">
                    <defs>
                    </defs>
                </svg>
                <div class="brand-title">
                    <h2 class="">Compagny</h2>
                    <span class="brand-sub-title">@mylordsteb</span>
                </div>
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item d-flex align-items-center">
                                <div class="input-group search-area">
                                    <input type="text" class="form-control" placeholder="Entrez une recherche...">
                            ...
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link bell-link " href="#">
                                <svg width="28" height="28" viewbox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="nav-item dropdown  header-profile">
                                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                    <img src="images/pic2.jpg" width="56" alt="">
                                </a>
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    <li><a class="" href="#" aria-expanded="true">
                    ...
                    <li><a class="" href="admin.php" aria-expanded="true">
                        <i class="fas fa-user-tie"></i>
                            <span class="nav-text">Liste membre <div style="position: relative;display: inline-block;color: red;">236</div></span>
                        </a>
                        
                    </li>
                    
                    <li><a class="" href="ajouter-membre.php" aria-expanded="false">
					...
					<div class="col-xl-12 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title text-primary">Ajouter membre</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <form>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <input type="password" class="form-control" placeholder="fonction">
                                            </div>
                                            <div class="mb-3 col-md-4">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                <div class="example">
		                                            <p class="mb-1">Date enregistrement</p>
