<div class="nav-header">
            <a href="email-composedrcb.php" class="brand-logo">
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li>
                    	<center>
                    		<a class="" href="email-composedrcb.php" aria-expanded="true">
                    			<div class="btn btn-primary"><i class="fas fa-pencil-alt"></i> Nouveau message</div>
                    		</a>
                    	</center>
                    </li>
                    <hr>
                    ...
                    <li><a class="" href="" aria-expanded="true">
						<i class="fas fa-table"></i>
							<span class="nav-text">Boite de reception <div style="position: relative;display: inline-block;color: red;">236</div></span>
						</a>
                    ...
                    <li><a class="" href="#" aria-expanded="false">
							...
							<span class="nav-text">Envoyés</span>
						</a>
